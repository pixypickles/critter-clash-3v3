...
function unit(team,i,type){
  ...
  return {team,i,type,x:bx,y:ys[i],r:27,alive:true,face:team?Math.PI:0,cd:0,stun:0,shield:false,shieldA:0,ai:team===1||i>0,species:(i%3)}
}
